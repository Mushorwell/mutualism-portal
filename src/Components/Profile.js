            ...
            <div className="row profileRow">
                ...
                <div className="col-sm-4">
                    <div className="dashboard-components middle-dash right-table profileTab">
                        ...
                        <Popup className="profileImageUploadContainer" trigger={<p className="actionText">Update logo</p>}>
                            <input className="profileImageInput" type="file" id="dpInput" onChange={updateDp} />
