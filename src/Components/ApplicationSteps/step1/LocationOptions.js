...
const LocationOptions = (props)=>{
    ...
    return(
        <div className="application-form inline-input-elements">
            <button className={`card1`} id="soweto" onClick={handleLocationOption} style={props.chosenLocation==='soweto'?{border: "solid 1px #007A4D"}:{border: "none"}}>
            ...
            <button className={`card1`} id="khayelitsha" onClick={handleLocationOption} style={props.chosenLocation==='khayelitsha'?{border: "solid 1px #007A4D"}:{border: "none"}}>
